...
gotg     = media.Movie("Guardians of the Galaxy",
                       "A band of miscreants teams up to take on a galactic"
                       " villain.",
...
kickass  = media.Movie("Kick-Ass",
                       "A bored high school student decides to become a"
                       " superhero.",
                       "https://upload.wikimedia.org/wikipedia/en/3/30/Kick-Ass_film_poster.jpg", #NOQA
                       "https://www.youtube.com/watch?v=rFpWpkxsVI8")

speed    = media.Movie("Speed Racer",
                       "A young stunt racer named Speed changes the sport"
                       " forever.",
...
prestige = media.Movie("The Prestige",
                       "A pair of magicians enter into a rivalry that threatens"
                       " to turn deadly.",
